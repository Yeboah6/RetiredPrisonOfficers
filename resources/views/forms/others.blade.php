            ...
            <form action="{{url('/others')}}" method="POST">
                ...
                <fieldset id="personal">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="present_occupation" placeholder="Enter Present Occupation (If any)">
                ...
                <div class="card-footer text-right">
                    <a href="/professional-info"><button type="button" class="btn" style="background-color: #a52a2acc;color: #fff">Back</button></a>
