...
{{-- <div class="container"> --}}
    ...
    <div class="row" style="margin-top: -110px;">
        <div class="col-md-6 offset-md-3">
            ...
            <form action="{{url('/edit-professional-info/'.$editProfessionalInfo -> id)}}" method="POST">
                ...
                <fieldset id="personal">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="date_of_enlistment" required placeholder="Enter Date of Enlistment" min="1990-06-02" max="2001-06-08" value="{{ $editProfessionalInfo -> date_of_enlistment }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="date_of_retirement" required placeholder="Enter Date of Retirement" value="{{ $editProfessionalInfo -> date_of_retirement }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rank_of_retirement" required placeholder="Enter Rank Of Retirement" value="{{ $editProfessionalInfo -> rank_of_retirement }}">
                ...
                <div class="card-footer text-right">
                    ...
                    <a href="{{url ('/edit-others/'.$editProfessionalInfo -> id) }}"><button type="button" class="btn" style="background-color: #a52a2acc;color: #fff">Next</button></a>
                </div>
            </form>
        </div>
    </div>
